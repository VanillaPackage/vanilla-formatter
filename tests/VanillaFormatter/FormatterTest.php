...
class PhoneFormatterTest extends PHPUnit_Framework_TestCase
{
    ...
    public function dataFormat()
    {
        return [
            ...
            [ '1.222.333-4', '12223334', 'ie', 'brazil' ],
            [ '11.222.333-4', '112223334', 'ie', 'brazil' ],
            [ '11.222.333-44', '1122233344', 'ie', 'brazil' ],
            [ '111.222.333-44', '11122233344', 'ie', 'brazil' ],
            [ '111.222.333.444', '111222333444', 'ie', 'brazil' ],
            [ '11.222.333/444-55', '1122233344455', 'ie', 'brazil' ],
